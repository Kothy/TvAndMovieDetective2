...
import com.example.klaud.tvandmoviedetective.Listeners.CustomOnItemSelectedListenerCities;
import com.example.klaud.tvandmoviedetective.Listeners.CustomOnItemSelectedListenerTheatres;
...
import com.example.klaud.tvandmoviedetective.Adapters.TheatresAdapter;
...
public class Theatres extends Fragment {
    ...
    static Spinner spinnerCities;
    public static Spinner spinnerTheatres;
    public static ArrayList<String> theatres = new ArrayList<>();
    public static ArrayList<String> urlForTheatres = new ArrayList<>();
    public static ArrayAdapter<String> adapter2;
    static ArrayAdapter<String> adapter;
    public static String city;
    public static TextView noProgram;
